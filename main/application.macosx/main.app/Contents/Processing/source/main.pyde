...
from com.metaball import Metaball
...
class bangListener3(ControlListener):
    def controlEvent(self, e):
        ...
        #myMB.drawBlack(300,1040,[[b.radius, b.position.x, b.position.y] for b in state['agents']])
        myMB.mb1(300,1040, [[b.radius, b.position.x, b.position.y] for b in state['agents']], state['bounds'], state['color']);
...
class bangListener4(ControlListener):
    def controlEvent(self, e):
        ...
        mb.renderMetaballs60(state['agents'], mb.draw1, state, myMB, toFill=False)
...
class bangListener5(ControlListener):
    def controlEvent(self, e):
        ...
        mb.renderMetaballs60(state['agents'], mb.draw1, state, myMB, toFill=True)
...
class bangListener31(ControlListener):
    def controlEvent(self, e):
        ...
        myMB.mb2(300,1040, [[b.radius, b.position.x, b.position.y] for b in state['agents']], state['bounds'], state['color']);
        #ControlPanel     
        #fill(100)
        #noStroke()
